...
var HomePage = (function () {
    ...
    HomePage.prototype.scan = function () {
        ...
        setTimeout(this.setStatus.bind(this), 5000, 'Búsqueda finalizada');
    };
...
HomePage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["n" /* Component */])({
        selector: 'page-home',template:/*ion-inline-start:"/home/mario/Documentos/ionic-ble-examples/connect/src/pages/home/home.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n      Seleccione SmartLock\n    </ion-title>\n    <ion-buttons end>\n      <button ion-button (click)="scan()">\n        Buscar\n      </button>\n    </ion-buttons>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n   <ion-list> \n    <button ion-item *ngFor="let device of devices" (click)="deviceSelected(device)">\n      <h2>{{ device.name || \'Unnamed\' }}</h2>\n      <p>{{ device.id }}</p>\n      <p>RSSI: {{ device.rssi }}</p>\n    </button>  \n   </ion-list> \n</ion-content>\n\n<ion-footer>\n  <ion-toolbar>\n    <p>{{ statusMessage }}</p>\n  </ion-toolbar>\n</ion-footer>\n'/*ion-inline-end:"/home/mario/Documentos/ionic-ble-examples/connect/src/pages/home/home.html"*/
    }),
...
var DetailPage = (function () {
    ...
    DetailPage.prototype.enviar = function (mensaje) {
        var device = this.navParams.get('device');
        var array = new Uint8Array(mensaje.length);
        for (var i = 0, l = mensaje.length; i < l; i++) {
            array[i] = mensaje.charCodeAt(i);
        }
        this.ble.write(device.id, '4fafc201-1fb6-459e-8fcc-c5c9c331914b', 'beb5483e-35e2-4688-b7f5-ea07361b26a8', array.buffer);
    };
    DetailPage.prototype.aaaaaaaa = function () {
        var mensaje = 'aaaaaaaa';
        this.enviar(mensaje);
    };
    DetailPage.prototype.bbbbbbbb = function () {
        var mensaje = 'bbbbbbbb';
        this.enviar(mensaje);
    };
    DetailPage.prototype.cccccccc = function () {
        var mensaje = 'cccccccc';
        this.enviar(mensaje);
    };
...
DetailPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-detail',template:/*ion-inline-start:"/home/mario/Documentos/ionic-ble-examples/connect/src/pages/detail/detail.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>{{ peripheral.name || \'Device\' }}</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content class="padding">\n\n  <ion-card>\n    <ion-card-header>\n      {{ peripheral.name || \'Unnamed\' }}\n    </ion-card-header>\n    <ion-card-content>\n      {{ peripheral.id }}\n    </ion-card-content>\n  </ion-card>\n  <div class="example-center"> \n    <button class="customBtn" ion-button (click)="aaaaaaaa()" expand="block" round="true" color="danger">\n          Bloqueo\n    </button><br><br>\n    <button class="customBtn" ion-button (click)="bbbbbbbb()" expand="block" round="true"  color="danger">\n          Desbloqueo\n    </button><br><br>\n    <button class="customBtn" ion-button (click)="cccccccc()" expand="block"round="true"  color="danger">\n          Desemparejamiento\n    </button>\n  </div>\n</ion-content>\n\n<ion-footer>\n  <ion-toolbar>\n    <p>{{ statusMessage }}</p>\n  </ion-toolbar>\n</ion-footer>\n'/*ion-inline-end:"/home/mario/Documentos/ionic-ble-examples/connect/src/pages/detail/detail.html"*/,
    }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__pages_detail_detail__ = __webpack_require__(194);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
MyApp = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({template:/*ion-inline-start:"/home/mario/Documentos/ionic-ble-examples/connect/src/app/app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"/home/mario/Documentos/ionic-ble-examples/connect/src/app/app.html"*/
    }),
